class ObjectNode:
    ...
    def add_child(self, child, voxel_size):
        import utils_it as utils
        if child is self:
            assert(1==2)
        self.children.append(child)
        self.object = utils.compute_fused_object([self.object, child.object], voxel_size)
        # update object of all parents
        parent = self.parent
        while parent is not None:
            parent.object = utils.compute_fused_object([parent.object, child.object], voxel_size)
